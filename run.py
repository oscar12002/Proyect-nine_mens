                ...
                if file_one.turn+1 > file_two.turn:
                    if quantl_files_1 == 3:
                        ...
                        if (pos_select_row+1, pos_select_column+1) in ((3,3), (3,4), (3,5), (4,3), (5,3), (5,4), (5,5), (4,5)):
                            if (pos_move_to_row+1, pos_move_to_column+1) in ((pos_select_row+1, pos_select_column+2), (pos_select_row+1, pos_select_column), (pos_select_row+2, pos_select_column+1), (pos_select_row, poself.s_select_column+1)):
                                if file_one.turn+1 > file_two.turn:
                                    player_move_one.fun_move(pos_select_row,pos_select_column,pos_move_to_row,pos_move_to_column)
