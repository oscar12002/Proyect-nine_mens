...
# hacer el mismo proceso que en add y move para ver si hay un molino aqui
class Eliminate: # With this class the files are eliminated
    ...
    def eliminate_files(self):
        ...
        while eliminate_turn != 1:
            ...
            for convert in v_e:
                if [row_eliminate, column_eliminate] in convert:
                    if (self.board_e.board_ret[convert[0][0]][convert[0][1]] == self.file_eliminate.m_simbol and self.board_2.board_ret[convert[1][0]][convert[1][1]] == " " + self.file_eliminate.m_simbol + " " and self.board_2.board_ret[convert[2][0]][convert[2][1]] == self.file_eliminate.m_simbol or
                       self.board_e.board_ret[convert[0][0]][convert[0][1]] == self.file_eliminate.m_simbol and self.board_2.board_ret[convert[1][0]][convert[1][1]] == self.file_eliminate.m_simbol and self.board_2.board_ret[convert[2][0]][convert[2][1]] == self.file_eliminate.m_simbol ):
                        pass
            else:
